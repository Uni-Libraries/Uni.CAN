...
static std::vector<std::shared_ptr<Auris::CAN::ICanProvider>> g_providers;
...
#if defined(_WIN32)
        g_providers.push_back(std::shared_ptr<Auris::CAN::ICanProvider>(new Auris::CAN::CanProviderChai()));
#endif
#if defined(_MSC_VER)
        g_providers.push_back(std::shared_ptr<Auris::CAN::ICanProvider>(new Auris::CAN::CanProviderIxxat()));
#endif
#if defined(__linux__)
        g_providers.push_back(std::make_shared<Auris::CAN::CanProviderSocketcan>());
#endif
    }
